...
set -k
python -u eval_seg.py -seed 1 -camera_idx 01234 -dataset airsim -model_dir airsim_seg_models -model_file "best-model=single_view-bsize=8-lrt=0.005-camera_idx=01234-backbone=mobilenetv2-seed=1-apply_noise_idx=None"
