...
set -k
gpu_idx=0
python -u training.py -seed 1 -camera_idx 01234 -dataset airsim-dgl -model_dir airsim_depth_models -model_file "model=multi_view_gcn-bsize=8-lrt=0.005-camera_idx=01234-backbone=mobilenetv2-seed=1-apply_noise_idx=None" -model multi_view_dgl -pretrained -backbone mobilenetv2 -gpu_idx $gpu_idx
