...
set -k
python -u training.py -seed 1 -camera_idx 01234 -dataset warehouse-dgl -model_dir warehouse_models -model_file "model=multi_view_gcn-bsize=8-lrt=0.005-camera_idx=01234-backbone=mobilenetv2-seed=1-apply_noise_idx=None" -model multi_view_dgl -pretrained -backbone mobilenetv2 -compress_gcn
